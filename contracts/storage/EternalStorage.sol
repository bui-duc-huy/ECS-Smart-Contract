...
contract EternalStorage {
    ...
    function set(bytes32 _key, address _value) public {
        addressStorage[_key] = _value;
    }

    function set(bytes32 _key, bool _value) public {
    ...
    function set(bytes32 _key, string memory _value) public {
        stringStorage[_key] = _value;
    }

    function set(bytes32 _key, bytes memory _value) public {
    ...
    function deleteArrayAddress(bytes32 _key, uint256 _index) public {
    ...
    function deleteArrayBytes32(bytes32 _key, uint256 _index) public {
    ...
    function deleteArrayUint(bytes32 _key, uint256 _index) public {
    ...
    function deleteArrayString(bytes32 _key, uint256 _index) public {
    ...
    function pushArray(bytes32 _key, address _value) public {
        addressArrayStorage[_key].push(_value);
    }

    function pushArray(bytes32 _key, bytes32 _value) public {
        bytes32ArrayStorage[_key].push(_value);
    }

    function pushArray(bytes32 _key, string memory _value) public {
        stringArrayStorage[_key].push(_value);
    }

    function pushArray(bytes32 _key, uint256 _value) public {
    ...
    function setArray(bytes32 _key, address[] memory _value) public {
        addressArrayStorage[_key] = _value;
    }

    function setArray(bytes32 _key, uint256[] memory _value) public {
        uintArrayStorage[_key] = _value;
    }

    function setArray(bytes32 _key, bytes32[] memory _value) public {
        bytes32ArrayStorage[_key] = _value;
    }

    function setArray(bytes32 _key, string[] memory _value) public {
    ...
    function getArrayString(bytes32 _key) public view returns(string[] memory) {
    ...
    function setArrayIndexValue(bytes32 _key, uint256 _index, address _value) public {
        addressArrayStorage[_key][_index] = _value;
    }

    function setArrayIndexValue(bytes32 _key, uint256 _index, uint256 _value) public {
        uintArrayStorage[_key][_index] = _value;
    }

    function setArrayIndexValue(bytes32 _key, uint256 _index, bytes32 _value) public {
        bytes32ArrayStorage[_key][_index] = _value;
    }

    function setArrayIndexValue(bytes32 _key, uint256 _index, string memory _value) public {
